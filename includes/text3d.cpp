...
namespace {
	...
	//Converte um vetor de 5 caracteres para float, como indicado no comentário
	...
	//Converte um vetor de 2 caracteres para unsigned short, utilizando little-endian
	//form
	...
	//Mesma coisa que auto_ptr, com arrays
	template<class T>
	class auto_array {
		private:
			T* array;
	...
	class T3DFont {
		...
		public:
			//Carrega o arquivo de fonte especificado em um novo objeto 3DFont
			T3DFont(ifstream &input) {
				...
				for(int i = 0; i < 94; i++) {
					...
					//Previne iterações excessivas ou loops infinitos em arquivos fonte
					//inválidos
					int limit = 10000;
...
BreakOuter2:
	...
	T3DFont* font = NULL; //A fonte usada para desenhar caracteres 2D e 3D
